        ...
        <div>
                    ...
                    <div className="container-fluid">
                        ...
                        <OwlCarousel
                            ...
                            <div className="item">
                                <div className="row">
                                    <div className="col-lg-6 col-md-12 left">
                                        <h1 data-aos="fade-up" data-aos-duration="1000" data-aos-delay="00">Land Your Dream Job <br />In Todays's <span className='grade-text'>High Demand</span><br /> Tech Fields<img src={bannerTextImg} alt="" className='img-fluid ms-3' /></h1>
                                        <p data-aos="fade-up" data-aos-duration="1000" data-aos-delay="200">Specialized courses & programs designed by experts to bridge the gap and make you a competitive candidate.</p>
                                        <div className="banner-btns">
                                            <a data-aos="fade-up" data-aos-duration="1000" data-aos-delay="300" href="" className='main-btn'>Expore Our Programs</a>
                                            <a data-aos="fade-up" data-aos-duration="1000" data-aos-delay="400" href="" className="video-btn">
                                    ...
                                    <div className="col-lg-6 col-md-12 right">
                                        <div className="banner-img-div" data-aos="fade-left" data-aos-duration="1000" data-aos-delay="200">
                            ...
                            <div className="item">
                                <div className="row">
                                    <div className="col-lg-6 col-md-12 left">
                                        <h1 data-aos="fade-up" data-aos-duration="1000" data-aos-delay="000">Explore Our Tech, Management & Leadership Programs<img src={bannerTextImg} alt="" className='img-fluid ms-3' /></h1>
                                        <p data-aos="fade-up" data-aos-duration="1000" data-aos-delay="200">We offer a comprehensive suite of programs designed to equip you with the critical skills and knowledge needed for success in tech careers</p>
                                        <div className="banner-btns">
                            ...
                            <div className="item">
                                <div className="row">
                                    <div className="col-lg-6 col-md-12 left">
                                        <h1 data-aos="fade-up" data-aos-duration="1000" data-aos-delay="000">Launch Your <img src={bannerTextImg} alt="" className='img-fluid ms-3' /><br />Tech Career with <br /><span className='grade-text'>STEM OPT Support</span><br /></h1>
                                        <p data-aos="fade-up" data-aos-duration="1000" data-aos-delay="200">Get the training, experience, and guidance you need to land your dream job after graduation.</p>
                                        <div className="banner-btns">
            ...
            <div className="main-about_sec">
                <div className="container">
                    <div className="row">
                        <div className="col-lg-6 left" data-aos="zoom-in" data-aos-duration="1000" data-aos-delay="000">
                        ...
                        <div className="col-lg-6 right" data-aos="zoom-in" data-aos-duration="1000" data-aos-delay="200">
            ...
            <div className="programs-sec">
                <div className="container">
                    <div className="top-sec">
                        <h2 className="main-head" data-aos="fade-up" data-aos-duration="1000" data-aos-delay="200">Our <span className="grade-text">Programes</span></h2>
                        <p className="main-para" data-aos="fade-up" data-aos-duration="1000" data-aos-delay="400">Our programs cater to a variety of career aspirations.</p>
                    </div>
                    <div className="programs-main">

                        <div className="programes-items" data-aos="fade-up" data-aos-duration="1000" data-aos-delay="200">
                        ...
                        <div className="programes-items" data-aos="fade-up" data-aos-duration="1000" data-aos-delay="400">
                            <div className="svg-div">
                        ...
                        <div className="programes-items" data-aos="fade-up" data-aos-duration="1000" data-aos-delay="600">
                            <div className="svg-div">
                    ...
                    <h6 className='text-center'  data-aos="fade-up" data-aos-duration="1000" data-aos-delay="200">Whether you're a seasoned professional looking to advance your career or a recent graduate seeking to enter the workforce with a strong foundation, we have a program for you.</h6>
                </div>
            </div>
            ...
            <div className="mentorship-prgrm-sec">
                <div className="container">
                    <div className="mentorship-main">
                        <div className="top-sec">
                            <h2 className="main-head" data-aos="fade-up" data-aos-duration="1000" data-aos-delay="200">Our Powerful Mentorship Program <br className='d-lg-block d-md-none d-none' /><span className="grade-text">Your Bridge to Success</span></h2>
                            <p className="main-para" data-aos="fade-up" data-aos-duration="1000" data-aos-delay="400">At MSITM Coach, we believe in the transformative power of mentorship. Our personalized mentorship program pairs you with an experienced tech professional who will become your trusted guide on your career journey.</p>
                        </div>
                        <div className="bottom-sec">
                            <div className="row inner-top">
                                <div className="col-lg-4 col-md-12 left" data-aos="zoom-in" data-aos-duration="1000" data-aos-delay="200">
                                    <div className="img-div">
                                ...
                                <div className="col-lg-8 col-md-12 right" data-aos="zoom-in" data-aos-duration="1000" data-aos-delay="400">
                        ...
                        <div className="cta-sec" data-aos="zoom-in" data-aos-duration="1000" data-aos-delay="200">
            ...
            <div className="set-us-apart-sec">
                <div className="container">
                    <h2 className="main-head text-center" data-aos="zoom-in" data-aos-duration="1000" data-aos-delay="200">Here's What <span className="grade-text">Sets Us Apart</span></h2>
                    <div className="main-div">

                        <div className="items" data-aos="zoom-in" data-aos-duration="1000" data-aos-delay="200">
                            <div className="icon-div">
                        ...
                        <div className="items" data-aos="zoom-in" data-aos-duration="1000" data-aos-delay="400">
                            <div className="icon-div">
                        ...
                        <div className="items" data-aos="zoom-in" data-aos-duration="1000" data-aos-delay="600">
                            <div className="icon-div">
                        ...
                        <div className="items" data-aos="zoom-in" data-aos-duration="1000" data-aos-delay="800">
                            <div className="icon-div">
            ...
            <div className="flexible-learning">
                <div className="container">
                    <div className="row">
                        <div className="col-lg-6 col-md-12 left" data-aos="zoom-in" data-aos-duration="1000" data-aos-delay="200">
                            <div className="img-div">
                        ...
                        <div className="col-lg-6 col-md-12 right">
                            <h2 className="main-head" data-aos="zoom-in" data-aos-duration="1000" data-aos-delay="200">Your Success, Your Way: Flexible Learning <span className="grade-text">Designed for You</span></h2>
                            <p className='main-para' data-aos="zoom-in" data-aos-duration="1000" data-aos-delay="400">Life gets busy. Don't let your education suffer. At MSITM Coach, we understand that everyone learns differently and has unique needs. That's why we offer a flexible program designed for you:</p>
                            <div className="main-points">

                                <div className="points" data-aos="zoom-in" data-aos-duration="1000" data-aos-delay="200">
                                ...
                                <div className="points" data-aos="zoom-in" data-aos-duration="1000" data-aos-delay="400">
            ...
            <div className="facualty-section">
                <div className="container">
                    <div className="row">
                        ...
                        <div className="col-lg-6 col-md-12 right" data-aos="zoom-in" data-aos-duration="1000" data-aos-delay="400">
                            <div className="img-div">
            ...
            <div className="testimonials-sec">
                <div className="top-sec" data-aos="fade-up" data-aos-duration="1000" data-aos-delay="200">
                    <div className="container">
                        <h2 className="main-head">Hear What Our <br /><span className="grade-text">Students Have To Say</span></h2>
                    </div>
                </div>

                <div className="video-container"  data-aos="fade-up" data-aos-duration="1000" data-aos-delay="400">
                ...
                <div className="written-testi-sec" data-aos="fade-up" data-aos-duration="1000" data-aos-delay="600">
                    <div className="container">
            ...
            <div className="placement-section">
                <div className="placement-main" data-aos="zoom-in" data-aos-duration="1000" data-aos-delay="00">
                    <div className="row">
                        <div className="col-lg-4 col-12 left">
                            <div className="top-sec">
                                <h2 className="main-head" data-aos="fade-up" data-aos-duration="1000" data-aos-delay="000">From Preparation to Placement</h2>
                                <p className="main-para" data-aos="fade-up" data-aos-duration="1000" data-aos-delay="200">We go beyond just preparing you for the job; we prepare you for the entire journey to landing it. Here's how we support your career success</p>
                                <a href="#" className="main-btn" data-aos="fade-up" data-aos-duration="1000" data-aos-delay="400">Get A Free Consultation</a>
                            </div>
                            <div className="img-div">
                                <img src={placementSecImg} alt="" className='img-fluid'  data-aos="fade-up" data-aos-duration="1000" data-aos-delay="600"/>
                            </div>
                        </div>
                        <div className="col-lg-8 col-12 right">

                            <div className="placement-points" data-aos="zoom-in" data-aos-duration="1000" data-aos-delay="200">
                            ...
                            <div className="placement-points" data-aos="zoom-in" data-aos-duration="1000" data-aos-delay="400">
            ...
            <div className="recent-placements" data-aos="zoom-in" data-aos-duration="1000" data-aos-delay="200">
                <div className="container">
            ...
            <div className="alumni-sec" data-aos="fade-up" data-aos-duration="1000" data-aos-delay="200">
            ...
            <div className="get-started-sec">
                <div className="container">
                    <div className="get-started-main">
                        <h2 className="main-head text-center" data-aos="zoom-in" data-aos-duration="1000" data-aos-delay="200">Need some help <span className="grade-text">getting started?</span></h2>
                        ...
                        <a href='' className="main-btn text-center" data-aos="zoom-in" data-aos-duration="1000" data-aos-delay="200">Start Your Assessment</a>
                    </div>
                </div>
            </div>

            <div className="course-section" data-aos="zoom-in" data-aos-duration="1000" data-aos-delay="200">
                <div className="container">
                    <div className="top-sec">
                ...
                <div className="container-fluid">
                    <div className="row">
                        ...
                        <div className="col-lg-6 col-12 right">
                            <h2 data-aos="zoom-in" data-aos-duration="1000" data-aos-delay="200">Don't let life hold you back. Take control of your education with our flexible program</h2>
                            <a href='' className="main-btn" data-aos="zoom-in" data-aos-duration="1000" data-aos-delay="400">Apply Now</a>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div className="opt-section">
                <div className="container">
                    ...
                    <div className="top-sec">
                        <h2 className="main-head" data-aos="fade-up" data-aos-duration="1000" data-aos-delay="000">Launch Your Tech Career <br />with <span className="grade-text">MSITM Coach OPT Support</span></h2>
                        <h6 data-aos="fade-up" data-aos-duration="1000" data-aos-delay="100">Are you an international student with a STEM degree from a US university?</h6>
                        <p className="main-para" data-aos="fade-up" data-aos-duration="1000" data-aos-delay="200">At MSITM Coach, we understand that transitioning from an MSITM graduate to a successful tech professional requires practical experience and job readiness. That's why we offer comprehensive support for students seeking Optional Practical Training (OPT).</p>
                    </div>

                    <div className="opt-program-sec">
                        <h3 className='text-center' data-aos="zoom-in" data-aos-duration="1000" data-aos-delay="200">Our OPT Program</h3>
                        <div className="grid-section">

                            <div className="opt-items opt-item-1" data-aos="zoom-in" data-aos-duration="1000" data-aos-delay="200">
                                <div className="img-div">
                            ...
                            <div className="opt-items opt-item-2" data-aos="zoom-in" data-aos-duration="1000" data-aos-delay="300">
                                <div className="img-div">
                            ...
                            <div className="opt-items opt-item-3" data-aos="zoom-in" data-aos-duration="1000" data-aos-delay="400">
                                <div className="img-div">
                            ...
                            <div className="opt-items opt-item-4" data-aos="zoom-in" data-aos-duration="1000" data-aos-delay="500">
                                <div className="img-div">
                            ...
                            <div className="opt-items opt-item-5" data-aos="zoom-in" data-aos-duration="1000" data-aos-delay="600">
                                <div className="img-div">
            ...
            <div className="benefits-sec">
                <div className="container">
                    <div className="row">
                        <div className="col-lg-6 col-12 left">
                            <h3 data-aos="zoom-in" data-aos-duration="1000" data-aos-delay="200">Benefits of MSITM Coach's <br />STEM OPT Program</h3>
                            <div className="icn-section">

                                <div className="items" data-aos="zoom-in" data-aos-duration="1000" data-aos-delay="100">
                                ...
                                <div className="items" data-aos="zoom-in" data-aos-duration="1000" data-aos-delay="300">
                                ...
                                <div className="items" data-aos="zoom-in" data-aos-duration="1000" data-aos-delay="500">
                        ...
                        <div className="col-lg-6 col-12 right" data-aos="zoom-in" data-aos-duration="1000" data-aos-delay="400">
                            <div className="img-div">
